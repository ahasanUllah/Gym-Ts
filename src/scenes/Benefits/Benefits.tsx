...
const Benefits = ({ setSelectedPage }: Props) => {
  return (
    <section className="mx-auto min-h-full w-5/6 p-20">
      <motion.div
      ...
      >
        ...
        <div className="mt-16 mt-28 items-center justify-between gap-20 md:flex">
          {/* GRAPHIC */}
          <img
          ...
          <div>
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true, amount: 0.5 }}
              transition={{ delaty: 0.2, duration: 1 }}
              variants={{
                hidden: { opacity: 0, x: 50 },
                visible: { opacity: 1, x: 0 },
              }}
